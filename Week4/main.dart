...
class MyApp extends StatelessWidget {
  ...
  Widget buildHomePage(String title) {
    ...
    const subTitle = Text(
      ...
      'The game began a closed beta period with limited access on April 7, 2020,'
      'followed by an official release on June 2, 2020.',
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Column(
              children: [
                Icon(Icons.computer_outlined, color: Colors.green[500]),
                const Text('OS System:'),
                const Text('Windows'),
                const Text('7/8/10/11'),
              ],
            ),
          ],
        ),
